...
def bonjour_monde
	...
	while i <= 5
		n = rand(379)
		login_twitter.update("#bonjour_monde pour #{journalists[n]} de la part des étudiants à TheHackingProject ! J'espere que tu passes une bonne journée")
		i += 1
	end
end
...
def streaming
	...
	stream_twitter.filter(track: topics.join(",")) do |object|
